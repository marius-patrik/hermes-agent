...
"""
    ...
    fleet_delegate = fleet_subparsers.add_parser("delegate", help="Queue a task for the orchestrator")
    fleet_delegate.add_argument("--task", required=True, help="Task summary to enqueue")
    fleet_delegate.add_argument("--role", default="worker", help="Requested worker role")
    fleet_delegate.add_argument("--profile", default="", help="Requested model profile")
    fleet_delegate.set_defaults(func=cmd_fleet, command="fleet")
    ...
    fleet_orch_sub = fleet_orch.add_subparsers(dest="orch_command")
    fleet_orch_start = fleet_orch_sub.add_parser("start", help="Start the orchestrator agent")
    fleet_orch_start.add_argument("--name", help="Human-friendly orchestrator name")
    fleet_orch_start.add_argument("--profile", default="", help="Fleet model profile name")
    fleet_orch_start.add_argument("--machine", default="local", help="Target machine id")
    fleet_orch_start.add_argument("--cwd", help="Working directory for the orchestrator")
    fleet_orch_start.add_argument("--command", help="Override startup command")
    fleet_orch_start.set_defaults(func=cmd_fleet, command="fleet", fleet_command="orch")
    fleet_orch_stop = fleet_orch_sub.add_parser("stop", help="Stop the orchestrator agent")
    fleet_orch_stop.set_defaults(func=cmd_fleet, command="fleet", fleet_command="orch")
    fleet_orch_status = fleet_orch_sub.add_parser("status", help="Show orchestrator status")
    fleet_orch_status.set_defaults(func=cmd_fleet, command="fleet", fleet_command="orch")
